...
export default function CourseRating({ courseId, isLoggedIn }: CourseRatingProps) {
    ...
    const fetchRatingData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log('Course rating data received:', data);
          setAverageRating(data.averageRating || 0);
          setTotalRatings(data.totalRatings || 0);
          setUserRating(data.userRating || 0);
        }
      } catch (error) {
        console.error('Error fetching course rating data:', error);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const handleRatingSubmit = async (rating: number) => {
    ...
    try {
      ...
      console.log('Course rating submission response:', data);
      ...
      console.error('Course rating submission error:', error);
