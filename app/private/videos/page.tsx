...
// Function to get user's videos from the database
async function getUserVideos(userId: string): Promise<VideoData[]> {
  await connectDB();
        ...
        <div className="p-8">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-400">Manage your uploaded video content</p>
            </div>
            <Link href="/private/videos/new">
          ...
          <div className="grid grid-cols-1 gap-6">
            {videos.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 mb-6">Start sharing your knowledge by uploading your first video</p>
                <Link href="/private/videos/new">
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white">
                    <PlusCircle className="h-4 w-4 mr-2" />
