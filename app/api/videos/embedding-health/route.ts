...
import { checkVideoEmbeddingServicesHealth } from "@/lib/video-embedding";
...
export async function GET() {
  try {
    ...
    const healthStatus = await checkVideoEmbeddingServicesHealth();
    ...
    console.error("Video embedding health check failed:", error);
    return NextResponse.json(
      { 
