...
import { Video, Eye, Users, Star, Clock, Edit, Trash2, Globe, Lock } from "lucide-react";
      ...
      <div className="container max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400">Video Details & Analytics</p>
          </div>
          <div className="flex gap-4">
            <Link href={`/tutor/videos/${video._id}/edit`}>
